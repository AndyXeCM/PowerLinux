...
```
bash <(curl --insecure -fsSL https://cdn.jsdelivr.net/gh/PowerLinux/PowerLinux@latest/scripts/install.sh)
```

- 直接更新

```
bash <(curl --insecure -fsSL https://cdn.jsdelivr.net/gh/PowerLinux/PowerLinux@latest/scripts/update.sh)
```

- 卸载脚本

```
wget --no-check-certificate -O uninstall.sh https://cdn.jsdelivr.net/gh/PowerLinux/PowerLinux@latest/scripts/uninstall.sh && bash uninstall.sh
```
